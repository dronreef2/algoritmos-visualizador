...
def demonstrar_metodologia_3_passos():
    ...
    problema = st.selectbox("Escolha um problema:", ["Fibonacci", "Climbing Stairs", "House Robber"])
...
def main():
    ...
    st.set_page_config(page_title="🧠 Algoritmos Interativos", page_icon="🧠", layout="wide")
