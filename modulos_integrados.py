...
class ModulosEducacionaisIntegrados:
    ...
    def __init__(self):
        self.modulos = {
            ...
            2: {
                ...
                "arquivos": ["metodologia_3_passos.py"],
            },
            3: {
                "nome": "Módulo 4: Entrevistas",
                "pasta": "modulo_4_entrevistas",
                "arquivos": ["interview_visualizer.py", "problem_playground.py"],
            },
        }
    ...
    def carregar_conteudo_modulo(self, modulo_id: int) -> Dict[str, Any]:
        ...
        conteudo = {"nome": modulo["nome"], "pasta": modulo["pasta"], "readme": None, "arquivos": {}, "estatisticas": {}}
        ...
        for arquivo in modulo["arquivos"]:
            ...
            if os.path.exists(arquivo_path):
                try:
                    ...
                    conteudo["arquivos"][arquivo] = {"erro": str(e)}
    ...
    def _extrair_algoritmos_principais(self, modulo_id: int) -> List[str]:
        ...
        algoritmos_por_modulo = {
            ...
            2: ["Metodologia 3 Passos", "Programação Dinâmica"],  # Módulo 3
            3: ["Visualizador de Entrevistas", "Problem Playground"],  # Módulo 4
        }

        return algoritmos_por_modulo.get(modulo_id, [])

    def executar_codigo_modulo(
        self, modulo_id: int, arquivo: str, funcao: str = None, parametros: Dict[str, Any] = None
    ) -> Dict[str, Any]:
