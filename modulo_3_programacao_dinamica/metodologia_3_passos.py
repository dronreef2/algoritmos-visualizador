...
def fibonacci_forca_bruta_com_passos(n: int) -> Tuple[int, List[Dict]]:
    ...
    def fib_recursive(num, depth=0):
        ...
        passos.append({"tipo": "chamada", "n": num, "depth": depth, "call_id": call_count, "action": f"Calculando F({num})"})
...
def fibonacci_tabulacao_com_passos(n: int) -> Tuple[int, List[Dict]]:
    ...
    passos.append({"tipo": "inicializacao", "dp_table": dp.copy(), "action": "Inicializando tabela DP: dp[0] = 0, dp[1] = 1"})
...
class Metodologia3Passos:
    ...
    def __init__(self):
        ...
        self.problemas_disponiveis = {
            ...
            "knapsack": {"forca_bruta": knapsack_forca_bruta_com_passos, "tabulacao": knapsack_tabulacao_com_passos},
            "lcs": {"tabulacao": lcs_tabulacao_com_passos},
            "coin_change": {"tabulacao": coin_change_tabulacao_com_passos},
        }
