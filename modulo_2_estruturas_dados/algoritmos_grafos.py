...
def bfs_com_passos(grafo, inicio):
    ...
    passos.append({
        'tipo': 'fim',
        'ordem_final': ordem_visita,
        'action': f'BFS completo. Ordem: {ordem_visita}'
    })
...
def dfs_com_passos(grafo, inicio):
    ...
    passos.append({
        'tipo': 'fim',
        'ordem_final': ordem_visita,
        'action': f'DFS completo. Ordem: {ordem_visita}'
    })
...
def kruskal_com_passos(grafo):
    ...
    passos.append({
        ...
        'mst_final': mst,
        'peso_total': peso_total,
        'action': f'MST completo. Peso total: {peso_total}'
    })
...
def detectar_ciclo_com_passos(grafo):
    ...
    def dfs_ciclo(v, passos):
        ...
        passos.append({
            ...
            'vertice': v,
            'cores': cores.copy(),
            'action': f'Visitando {v} (marcado como cinza)'
        })
    ...
    passos.append({
        'tipo': 'inicio',
        'cores': cores.copy(),
        'action': 'Iniciando detecção de ciclo com DFS'
    })
