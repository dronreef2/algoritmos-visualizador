...
def test_modulo_2():
    ...
    try:
        from modulo_2_estruturas_dados.estruturas_avancadas import AdvancedHeap, Trie, UnionFind, SegmentTree, LRUCache
...
def test_modulo_4():
    ...
    try:
        from modulo_4_entrevistas.problem_playground import InterviewSession, TWO_SUM_PROBLEM, VALID_PARENTHESES_PROBLEM
...
def test_visualizadores():
    ...
    try:
        ...
        heap_data = {"heap": [1, 4, 3, 7, 8, 5], "is_max_heap": False, "size": 6, "operations": []}
        ...
        # Dados de teste
        steps = [{"tipo": "inicio", "nums": [2, 7, 11, 15], "target": 9, "hash_map": {}, "current_index": -1}]
